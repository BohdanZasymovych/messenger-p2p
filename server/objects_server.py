...
class Server:
    ...
    async def __handle_get_long_term_public_key_request(self, websocket: WebSocket, data: dict):
    ...
    async def __handle_get_public_key_request(self, user_id: str, data: dict):
        ...
        await self.__clients[user_id].websockets[target_user_id].send(get_public_key_request.json_string)
