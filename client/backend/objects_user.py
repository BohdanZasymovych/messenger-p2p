...
class App:
    ...
    def __init__(self):
        ...
        self.api.mount("/static", StaticFiles(directory=frontend_path, html=True), name="static")

        # Correctly resolve the path to the 'auth' directory
        auth_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "frontend/auth"))

        # Mount the 'auth' directory
        self.api.mount("/auth", StaticFiles(directory=auth_path), name="auth")

        # Mount the 'chat' directory
        chat_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "frontend/chat"))
        self.api.mount("/chat", StaticFiles(directory=chat_path, html=True), name="chat")
